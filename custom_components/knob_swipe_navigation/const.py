...
FRONTEND_MODULE_URL = f"{FRONTEND_URL_PATH}/{FRONTEND_MODULE}?v=0.3.7"
...
CONF_IDLE_RETURN_ENABLED = "idle_return_enabled"
CONF_IDLE_RETURN_TIMEOUT_SECONDS = "idle_return_timeout_seconds"
...
DEFAULT_IDLE_RETURN_ENABLED = True
DEFAULT_IDLE_RETURN_TIMEOUT_SECONDS = 60

MIN_OVERLAY_TIMEOUT_MS = 500
MAX_OVERLAY_TIMEOUT_MS = 10000
MIN_COOLDOWN_MS = 0
MAX_COOLDOWN_MS = 10000
MIN_IDLE_RETURN_TIMEOUT_SECONDS = 1
MAX_IDLE_RETURN_TIMEOUT_SECONDS = 86400
...
ENTITY_IDLE_RETURN_ENABLED = "idle_return_enabled"
ENTITY_IDLE_RETURN_TIMEOUT_SECONDS = "idle_return_timeout_seconds"
